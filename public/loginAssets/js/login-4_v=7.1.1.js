...
var KTLogin = function() {
	...
	var _handleFormSignup = function() {
			...
			form,
			{
				fields: {
					...
					password_confirmation: {
						validators: {
							notEmpty: {
								message: 'Şifre tekrarlama gereklidir'
							}
						}
					},
					email: {
			...
			if (validator) {
				validator.validate().then(function (status) {
					if (status == 'Valid') {
						...
						Swal.fire({
							text: "Üzgünüz, gerekli alanları doldurmanız gerekmektedir !",
							icon: "error",
							buttonsStyling: false,
		...
		wizardObj.on('submit', function (wizard) {
			Swal.fire({
				text: "Herşey Tamam. Devam Edilsin mi ?",
				icon: "success",
