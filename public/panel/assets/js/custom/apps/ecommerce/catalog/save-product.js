            ...
            [
                ...
                t &&
                    (t = new Quill(e, {
                        ...
                        placeholder: "Uzun açıklama yazınız...",
                        theme: "snow",
                    }));
                if (t) {
                    ...
                    input.name = "text";
                    input.type = "hidden";
                    input.id = "text_changed";
                    document
                        .querySelector("#kt_ecommerce_add_product_form")
                        .insertAdjacentElement("beforeend", input);
                    t.on("text-change", function (e) {
                        document.querySelector("#text_changed").value = document
                            .querySelector(
                                "#kt_ecommerce_add_product_description"
                            )
                ...
                new Dropzone("#kt_ecommerce_add_product_media", {
                    url:
                        ...
                        + `/${document.querySelector('#watermark_photo').value}`
                    ...
                    formData.append("watermark_position",document.querySelector('input[name="watermark_position"]:checked').value);
                    formData.append("watermark_size",document.querySelector('input[name="watermark_size"]').value);
                    formData.append("watermark_opacity",document.querySelector('input[name="watermark_opacity"]').value);
                    formData.append("watermark_rotate",document.querySelector('input[name="watermark_rotate"]').value);
                    formData.append("is_watermark",document.querySelector('#watermark_photo').value);
                })
                .on('success',(file,res)=>{
                    console.log(res);
                }),
