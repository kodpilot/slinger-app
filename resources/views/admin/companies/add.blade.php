...
@section('mainTitle', __('Şirket Ekle'))
@section('path1', 'Panel')
    ...
    <div id="kt_content_container" class="d-flex flex-column-fluid align-items-start container-xxl">
        ...
        <div class="content flex-row-fluid" id="kt_content">
            ...
            <form id="kt_ecommerce_add_product_form" class="form d-flex flex-column flex-lg-row" method="post"
                action="{{ route('company.create') }}" enctype="multipart/form-data">
                @csrf
                <!--begin::Aside column-->
                        ...
                        <div class="card-body text-center pt-0">
                            ...
                            <div class="image-input image-input-empty image-input-outline mb-3" data-kt-image-input="true"
                                ...
                                <label class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow"
                                    ...
                                    <!--begin::Inputs-->
                                    <input required type="file" name="file" accept=".png, .jpg, .jpeg" />
                ...
                <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                    ...
                    <ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-bold mb-n2">
                        ...
                        <!--begin:::Tab item-->
                        <li class="nav-item">
                            <a class="nav-link text-active-primary pb-4" data-bs-toggle="tab" href="#category">{{__('Kategoriler')}}</a>
                        </li>
                        <!--end:::Tab item-->
                        ...
                        <div class="tab-pane fade show active" id="general" role="tab-panel">
                            <div class="d-flex flex-column gap-7 gap-lg-10">
                                ...
                                <div class="card card-flush py-4">
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <div class="mb-10 fv-row">
                                            ...
                                            <!--end::Label-->
                                            <input type="text" class="form-control mb-2" placeholder="Şirket Adı" name="name">
                                        </div>
                                        <!--end::Input group-->
                                        <!--begin::Input group-->
                                        <div class="mb-10 fv-row">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input required type="text" name="description" class="form-control mb-2"
                                                placeholder="{{__('Kısa Açıklama')}}" value="" />
                                            <!--end::Input-->
                                            <!--begin::Description-->
                                        ...
                                        <!--end::Input group-->
                                        <input type="hidden" name="newPrice" value="0">
                                        <!--begin::Input group-->
                                        <!--end::Input group-->
                                    </div>
                                    <!--end::Card header-->
                                ...
                                <div class="d-none mb-10 fv-row" id="kt_ecommerce_add_product_discount_fixed">
                                    <!--begin::Label-->
                                    <label class="form-label">{{__('İndirimli Fiyat')}}</label>
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" name="price" class="form-control mb-2"
                                        placeholder="{{__('İndirimli Fiyat')}}" value="0" />
                                    <!--end::Input-->
                                    <!--begin::Description-->
                                    <div class="text-muted fs-7">{{__('Bu ayarı yaptığınızda ürüne indirimli fiyat yazılacakıtır')}}.</div>
                                    <!--end::Description-->
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="d-flex flex-column gap-7 gap-lg-10">
                                ...
                                <div class="card card-flush py-4">
                                    ...
                                    <div class="card-body pt-0">
                                        <!--begin::Form-->
                                        <form class="form"
                                            action="{{ route('photo.create', ['id' => $new_id]) }}" method="post">
                                            @csrf
                                            ...
                                            <div class="fv-row mb-2">
                                                ...
                                                <div class="dropzone" id="kt_ecommerce_add_product_media">
                                                    <input type="hidden" value="{{ $new_id }}" id="product_id">
                                                    <!--begin::Message-->
                                                    ...
                                                    <div data-repeater-list="categories" class="d-flex flex-column gap-3">
                                                        <div data-repeater-item="" class="form-group d-flex flex-wrap gap-5">
                                                            ...
                                                            <div class="w-100 w-md-300px">
                                                                <select required class="form-select" onchange="getMultipleSelected(event)" data-id="main"  name="category_id" data-placeholder="{{__('Kategori Seçiniz')}}" data-kt-ecommerce-catalog-add-category="condition_type">
                                                            ...
                                                            <!--begin::Select2-->
                                                            <div class="w-100 w-md-300px">
                                                                <select class="form-select" data-id="sub" name="subcategory_id" data-placeholder="{{__('Alt Kategori Seçiniz(optional)')}}" data-kt-ecommerce-catalog-add-category="condition_equals">
                                                                </select>
                                                            </div>
                                                            <!--end::Select2-->
                                                            <!--begin::Button-->
                    ...
                    <div class="d-flex justify-content-end">
                        <!--begin::Button-->
                        <a href="{{ route('company.index') }}" id="kt_ecommerce_add_product_cancel" class="btn btn-light me-5">{{__('İptal')}}</a>
                        <!--end::Button-->
                        <!--begin::Button-->
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="preview">
                        <div class="p_watermark d-flex justify-content-center align-items-center flex-column text-center">watermark</div>
                    </div>
                </div>
