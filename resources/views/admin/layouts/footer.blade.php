...
<div class="footer py-4 d-flex flex-lg-column" id="kt_footer">
    ...
    <div class="container-xxl d-flex flex-column flex-md-row align-items-center justify-content-between">
        ...
        <ul class="menu menu-gray-600 menu-hover-primary fw-bold order-1">
            <li class="menu-item">
                <a href="https://kodpilot.com" target="_blank" class="menu-link px-2">{{__('Hakkımızda')}}</a>
            </li>
            <li class="menu-item">
                <a href="https://kodpilot.com/iletisim" target="_blank" class="menu-link px-2">{{__('İletişim')}}</a>
            </li>
            <li class="menu-item">
                <a href="https://kodpilot.com" target="_blank" class="menu-link px-2">{{__('Portfolyo')}}</a>
            </li>
        </ul>
        <!--end::Menu-->
    </div>
    ...
    <div class="card w-100 rounded-0 border-0" id="kt_drawer_chat_messenger">
        ...
        <div class="card-header pe-5" id="kt_drawer_chat_messenger_header">
            ...
            <div class="card-title">
                <!--begin::User-->
                <div class="d-flex justify-content-center flex-row me-3">
                    <div class="symbol symbol-40px symbol-md-50px">
                        <img src="{{ url('panel/assets/media/svg/avatars/pilot.svg') }}"
                            alt="Kodpilot Robotu" />
                    </div>
                    <a href="#" class="fs-4 fw-bolder text-gray-900 text-hover-primary me-1 mb-2 lh-1">{{__('Asistan')}}</a>
                    <!--begin::Info-->
                    <div class="mb-0 lh-1">
                        <span class="badge badge-success badge-circle w-10px h-10px me-1"></span>
                        <span class="fs-7 fw-bold text-muted">{{__('Aktif')}}</span>
                    </div>
                    <!--end::Info-->
                </div>
                <!--end::User-->
            ...
            <div class="scroll-y me-n5 pe-5" data-kt-element="messages" data-kt-scroll="true"
                ...
                <div class="d-flex justify-content-start mb-10">
                    ...
                    <div class="d-flex flex-column align-items-start">
                        @foreach (asistans() as $item)
                            <!--begin::User-->
                            <div class="d-flex align-items-center mb-2">
                                <!--begin::Avatar-->
                                <div class="symbol symbol-35px symbol-circle">
                                    <img alt="Pic" src="{{ url('panel/assets/media/svg/avatars/pilot.svg') }}" />
                                </div>
                                <!--end::Avatar-->
                                <!--begin::Details-->
                                <div class="ms-3">
                                    <a href="#" class="fs-5 fw-bolder text-gray-900 text-hover-primary me-1">{{__('Asistan')}}</a>
                            ...
                            <div class="p-5 rounded bg-light-info text-dark fw-bold mw-lg-400px text-start"
                                data-kt-element="message-text">{!!__($item->description)!!} {{$item->description2}}</div>
                            <!--end::Text-->
                        @endforeach
