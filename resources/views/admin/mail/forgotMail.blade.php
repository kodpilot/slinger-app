				...
				<td align="left" valign="center">
					<div style="text-align:left; margin: 0 20px; padding: 40px; background-color:#ffffff; border-radius: 6px">
						...
						<div style="padding-bottom: 30px; font-size: 17px;">
							<strong>Şifre Yenileme Formu</strong>
						</div>
						<div style="padding-bottom: 30px">Şifrenizi yenilemek için aşağıdaki butonu kullanabilirsiniz.</div>
						<div style="padding-bottom: 40px; text-align:center;">
							<a href="{{ route('reset-password',['mail'=>$mail,'token'=>$token]) }}" rel="noopener" 
						...
						<div style="padding-bottom: 50px; word-wrap: break-all;">
							...
							<a href="{{ url('reset/'.$mail.'/'.$token) }}" rel="noopener" target="_blank" style="text-decoration:none;color: #50CD89">{{ route('reset-password',['mail'=>$mail,'token'=>$token]) }}</a>
						</div>
						<!--end:Email content-->
