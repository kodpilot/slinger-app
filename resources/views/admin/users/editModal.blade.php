            ...
            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                ...
                <form class="form" method="post" action="{{route('user.update', ['id' => $user->id])}}" enctype="multipart/form-data">
                    ...
                    <div class="mb-13 text-center">
                        <!--begin::Title-->
                        <h1 class="mb-3">{{__('Üye Güncelle')}}</h1>
                        <!--end::Title-->
                    </div>
                    <!--end::Heading-->
                    <!--begin::Col-->
                    ...
                    <div class="row g-9 mb-8">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <input type="text" class="form-control form-control-solid"
                                placeholder="{{__('İsim')}} " name="name" value="{{$user->name}}"/>
                        </div>
                        <div class="col-md-6 fv-row">
                            <!--begin::Label-->
                            <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                            ...
                            <!--end::Label-->
                            <input type="text" class="form-control form-control-solid"
                                placeholder="{{__('Soyad')}} " name="surname" value="{{$user->surname}}"/>
                        </div>
                        <!--end::Col-->
                        <!--begin::Col-->
                        <div class="col-md-6 fv-row">
                            ...
                            <!--end::Label-->
                            <input type="text" class="form-control form-control-solid"
                                placeholder="{{__('Mail')}} " name="email" value="{{$user->email}}"/>
                        </div>
                        <!--end::Col-->
                         <!--begin::Col-->
                         <div class="col-md-6 fv-row">
                    ...
                    <div class="row g-9 mb-8">
                         ...
                         <div class="col-md-6 fv-row">
                            ...
                            <select name="admin" class="form-control form-control-lg form-control-solid form-select" required="true">
                                <option selected>{{__('Seçiniz')}}</option>
                                <option value="0" >{{__('Kullanıcı/Müşteri')}}</option>
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <!--end::Label-->
                            <input type="text" class="form-control form-control-solid"
                                placeholder="Şifre " name="password_confirmation"  />
                        </div> --}}
                        <!--end::Col-->
                    </div>
                    <!--end::Input group-->
