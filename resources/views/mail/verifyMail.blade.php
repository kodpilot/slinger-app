		...
		<tbody>
			<tr>
				<td align="center" valign="center" style="text-align:center; padding: 40px">
					<a href="{{ url('index') }}" rel="noopener" target="_blank">
				...
				<td align="left" valign="center">
					<div style="text-align:left; margin: 0 20px; padding: 40px; background-color:#ffffff; border-radius: 6px">
						...
						<div style="padding-bottom: 50px; word-wrap: break-all;">
							...
							<a href="https://keenthemes.com/account/confirm/07579ae29b6?email=max%40kt.com" rel="noopener" target="_blank" style="text-decoration:none;color: #50CD89">https://keenthemes.com/account/confirm/07579ae29b6?email=max%40kt.com</a>
						</div>
						<!--end:Email content-->
