                ...
                <form id="kt_modal_new_card_form" class="form">
                    ...
                    <div class="d-flex flex-column mb-7 fv-row">
                        ...
                        <div class="position-relative">
                            <!--begin::Input-->
                            <input type="text" pattern="[0-9\s]{13,19}" class="form-control form-control-solid" placeholder="Kart Numaranızı Giriniz" name="card_number" value="" />
                            <!--end::Input-->
                        </div>
                        <!--end::Input wrapper-->
                    </div>
                    ...
                    <div class="row mb-10">
                        ...
                        <div class="col-md-8 fv-row">
                            <!--begin::Label-->
                            <label class="required fs-6 fw-bold form-label mb-2">Son Kullanma Tarihi</label>
                            <!--end::Label-->
                            <!--begin::Row-->
                        ...
                        <div class="col-md-4 fv-row">
                            ...
                            <label class="d-flex align-items-center fs-6 fw-bold form-label mb-2">
                                ...
                                <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="CVV"></i>
                            </label>
                            <!--end::Label-->
                            <!--begin::Input wrapper-->
                            <div class="position-relative">
                    ...
                    <div class="text-center pt-15">
                        <button type="reset" id="kt_modal_new_card_cancel" class="btn btn-light me-3">İptal Et</button>
...
<script src="/panel/assets/js/particulars/cartPayment.js"></script>
