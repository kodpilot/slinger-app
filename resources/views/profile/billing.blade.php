...
<script src="{{ url('panel/assets/js/custom/utilities/modals/new-address.js') }}"></script>
		...
		<div class="card">
			...
			<div class="card-header card-header-stretch border-bottom border-gray-200">
				...
				<div class="card-title">
					<h3 class="fw-bolder m-0">Faturalandırma</h3>
				</div>
				<!--end::Title-->
			</div>
			<!--end::Card header-->
					...
					<div class="table-responsive">
						...
						<table class="table table-row-bordered align-middle gy-4 gs-9">
							<thead class="border-bottom border-gray-200 fs-6 text-gray-600 fw-bolder bg-light bg-opacity-75">
								<tr>
									<td class="min-w-150px">Teslim Tarihi</td>
									<td class="min-w-250px">Sipariş Tutarı</td>
									<td class="min-w-150px">Fatura</td>
								</tr>
							</thead>
							<tbody class="fw-bold text-gray-600">
								...
								<tr>
									...
									<td class="text-begin">
										<a href="{{ route('profile.viewInvoice', ['id' => $order->order_id]) }}"
							...
							<div class="d-flex flex-column mb-7 fv-row">
								...
								<div class="position-relative">
									...
									<div class="position-absolute translate-middle-y top-50 end-0 me-5">
										<img src="{{ url('panel/assets/media/svg/card-logos/visa.svg') }}" alt="" class="h-25px" />
										<img src="{{ url('panel/assets/media/svg/card-logos/mastercard.svg') }}" alt="" class="h-25px" />
										<img src="{{ url('panel/assets/media/svg/card-logos/american-express.svg') }}" alt="" class="h-25px" />
									</div>
									<!--end::Card logos-->
								</div>
								<!--end::Input wrapper-->
