...
<div class="footer py-4 d-flex flex-lg-column" id="kt_footer">
    ...
    <div class="container-xxl d-flex flex-column flex-md-row align-items-center justify-content-between">
        ...
        <div class="text-dark order-2 order-md-1">
            ...
            <a href="https://kodpilot.com" target="_blank" class="text-gray-800 text-hover-primary">Kodpilot</a>
        </div>
        <!--end::Copyright-->
        <!--begin::Menu-->
        <ul class="menu menu-gray-600 menu-hover-primary fw-bold order-1">
            <li class="menu-item">
                <a href="https://kodpilot.com" target="_blank" class="menu-link px-2">Hakkımızda</a>
            </li>
            <li class="menu-item">
                <a href="https://kodpilot.com/iletisim" target="_blank" class="menu-link px-2">İletişim</a>
            </li>
            <li class="menu-item">
                <a href="https://kodpilot.com" target="_blank" class="menu-link px-2">Portfolyo</a>
            </li>
        </ul>
        <!--end::Menu-->
    </div>
                            ...
                            <div class="pe-3 mb-5">
                                ...
                                <div class="d-flex align-items-center mt-1 fs-6">
                                    ...
                                    <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip"
                                        ...
                                        <img src="{{ url('panel/assets/media/avatars/300-14.jpg') }}" alt="img" />
                                    </div>
                                    <!--end::User-->
                                </div>
                                <!--end::Description-->
                            ...
                            <div class="overflow-auto pb-5">
                                ...
                                <div
                                    ...
                                    <div class="symbol-group symbol-hover flex-nowrap flex-grow-1 min-w-100px pe-2">
                                        ...
                                        <div class="symbol symbol-circle symbol-25px">
                                            <img src="{{ url('panel/assets/media/avatars/300-2.jpg') }}" alt="img" />
                                        </div>
                                        <!--end::User-->
                                        <!--begin::User-->
                                        <div class="symbol symbol-circle symbol-25px">
                                ...
                                <div
                                    ...
                                    <div class="symbol-group symbol-hover flex-nowrap flex-grow-1 min-w-100px">
                                        <!--begin::User-->
                                        <div class="symbol symbol-circle symbol-25px">
                                            <img src="{{ url('panel/assets/media/avatars/300-20.jpg') }}" alt="img" />
                                        </div>
                                        <!--end::User-->
                                        <!--begin::User-->
                                        <div class="symbol symbol-circle symbol-25px">
                            ...
                            <div class="overflow-auto pe-3">
                                ...
                                <div class="d-flex align-items-center mt-1 fs-6">
                                    ...
                                    <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip"
                                        ...
                                        <img src="{{ url('panel/assets/media/avatars/300-1.jpg') }}" alt="img" />
                                    </div>
                                    <!--end::User-->
                                </div>
                                <!--end::Description-->
                            ...
                            <div class="mb-5 pe-3">
                                ...
                                <div class="d-flex align-items-center mt-1 fs-6">
                                    ...
                                    <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip"
                                        ...
                                        <img src="{{ url('panel/assets/media/avatars/300-23.jpg') }}" alt="img" />
                                    </div>
                                    <!--end::User-->
                                </div>
                                <!--end::Description-->
                                ...
                                <div
                                    ...
                                    <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
                                        ...
                                        <img alt="" class="w-30px me-3"
                                            src="{{ url('panel/assets/media/svg/files/pdf.svg') }}" />
                                        <!--end::Icon-->
                                        <!--begin::Info-->
                                    ...
                                    <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
                                        ...
                                        <img alt="/metronic8/demo20/../demo20/apps/projects/project.html"
                                            class="w-30px me-3"
                                            src="{{ url('panel/assets/media/svg/files/doc.svg') }}" />
                                        <!--end::Icon-->
                                        <!--begin::Info-->
                                        <div class="ms-1 fw-bold">
                                            <!--begin::Desc-->
                                    ...
                                    <div class="d-flex flex-aligns-center">
                                        ...
                                        <img alt="/metronic8/demo20/../demo20/apps/projects/project.html"
                                            class="w-30px me-3"
                                            src="{{ url('panel/assets/media/svg/files/css.svg') }}" />
                                        <!--end::Icon-->
                                        <!--begin::Info-->
                                        <div class="ms-1 fw-bold">
                                            <!--begin::Desc-->
                        ...
                        <div class="timeline-content mb-10 mt-n1">
                            ...
                            <div class="pe-3 mb-5">
                                ...
                                <div class="fs-5 fw-bold mb-2">Task
                                    ...
                                    <a href="#" class="text-primary fw-bolder me-1">#45890</a>in “Ads Pro panel
                                    Dashboard project:
                                </div>
                                <!--end::Title-->
                                <!--begin::Description-->
                            ...
                            <div class="overflow-auto pb-5">
                                <div
                                    ...
                                    <div class="overlay me-10">
                                        ...
                                        <div class="overlay-wrapper">
                                            <img alt="img" class="rounded w-150px"
                                                src="{{ url('panel/assets/media/stock/600x400/img-29.jpg') }}" />
                                        </div>
                                        <!--end::Image-->
                                        <!--begin::Link-->
                                    ...
                                    <div class="overlay me-10">
                                        ...
                                        <div class="overlay-wrapper">
                                            <img alt="img" class="rounded w-150px"
                                                src="{{ url('panel/assets/media/stock/600x400/img-31.jpg') }}" />
                                        </div>
                                        <!--end::Image-->
                                        <!--begin::Link-->
                                        <div class="overlay-layer bg-dark bg-opacity-10 rounded">
                                    ...
                                    <div class="overlay">
                                        ...
                                        <div class="overlay-wrapper">
                                            <img alt="img" class="rounded w-150px"
                                                src="{{ url('panel/assets/media/stock/600x400/img-40.jpg') }}" />
                                        </div>
                                        <!--end::Image-->
                                        <!--begin::Link-->
                                        <div class="overlay-layer bg-dark bg-opacity-10 rounded">
                            ...
                            <div class="pe-3 mb-5">
                                ...
                                <div class="d-flex align-items-center mt-1 fs-6">
                                    ...
                                    <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip"
                                        ...
                                        <img src="{{ url('panel/assets/media/avatars/300-4.jpg') }}" alt="img" />
                                    </div>
                                    <!--end::User-->
                                </div>
                                <!--end::Description-->
                                ...
                                <div
                                    ...
                                    <div class="d-flex flex-stack flex-grow-1 flex-wrap flex-md-nowrap">
                                        ...
                                        <div class="mb-3 mb-md-0 fw-bold">
                                            ...
                                            <div class="fs-6 text-gray-700 pe-7">Login into panel Dashboard to make
        ...
        <div class="card-header pe-5" id="kt_drawer_chat_messenger_header">
            ...
            <div class="card-title">
                ...
                <div class="d-flex justify-content-center flex-column me-3">
                    <a href="#" class="fs-4 fw-bolder text-gray-900 text-hover-primary me-1 mb-2 lh-1">Sipariş Durumun</a>
                    <!--begin::Info-->
                    <div class="mb-0 lh-1">
                        @isset($lastUpdate->status)
                        @if ($lastUpdate->status == 'Tamamlandı')
                        <span class="badge badge-success badge-circle w-10px h-10px me-1"></span>
                        <span class="fs-7 fw-bold text-muted">Son siparişiniz tamamlandı.</span>
                        @elseif($lastUpdate->status == 'Hazırlanıyor')
                        <span class="badge badge-warning badge-circle w-10px h-10px me-1"></span>
                        <span class="fs-7 fw-bold text-muted">Son siparişiniz hazırlanıyor.</span>
                        @elseif($lastUpdate->status == 'Bekleniyor')
                        <span class="badge badge-light-dark badge-circle w-10px h-10px me-1"></span>
                        <span class="fs-7 fw-bold text-muted">Son siparişinizin durumu bekleniyor.</span>
                        @elseif($lastUpdate->status == 'Kargoya Verildi')
                        <span class="badge badge-primary badge-circle w-10px h-10px me-1"></span>
                        <span class="fs-7 fw-bold text-muted">Son siparişiniz kargoya verildi.</span>
                        
                        @else
                        <span class="badge badge-light-dark badge-circle w-10px h-10px me-1"></span>
                        <span class="fs-7 fw-bold text-muted">Son siparişiniz iptal edildi.</span>
                        @endif
                        @else
                        <span class="badge badge-dark badge-circle w-10px h-10px me-1"></span>
                        <span class="fs-7 fw-bold text-muted">Henüz sipariş vermediniz.</span>
                        @endisset
                    </div>
                    <!--end::Info-->
                </div>
                                    ...
                                    <div class="mh-300px scroll-y me-n7 pe-7">
                                        ...
                                        <div
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="symbol symbol-35px">
                                                    <img src="{{ url('panel/assets/media/svg/files/pdf.svg') }}"
                                                        alt="icon" />
                                                </div>
                                                <!--end::Avatar-->
                                                <!--begin::Details-->
                                        ...
                                        <div
                                            ...
                                            <div class="d-flex align-items-center">
                                                <!--begin::Avatar-->
                                                <div class="symbol symbol-35px">
                                                    <img src="{{ url('panel/assets/media/svg/files/tif.svg') }}"
                                                        alt="icon" />
                                                </div>
                                                <!--end::Avatar-->
                                                <!--begin::Details-->
                                        ...
                                        <div
                                            ...
                                            <div class="d-flex align-items-center">
                                                <!--begin::Avatar-->
                                                <div class="symbol symbol-35px">
                                                    <img src="{{ url('panel/assets/media/svg/files/folder-document.svg') }}"
                                                        alt="icon" />
                                                </div>
                                                <!--end::Avatar-->
                                                <!--begin::Details-->
                                        ...
                                        <div
                                            ...
                                            <div class="d-flex align-items-center">
                                                <!--begin::Avatar-->
                                                <div class="symbol symbol-35px">
                                                    <img src="{{ url('panel/assets/media/svg/files/css.svg') }}"
                                                        alt="icon" />
                                                </div>
                                                <!--end::Avatar-->
                                                <!--begin::Details-->
                                        ...
                                        <div
                                            ...
                                            <div class="d-flex align-items-center">
                                                <!--begin::Avatar-->
                                                <div class="symbol symbol-35px">
                                                    <img src="{{ url('panel/assets/media/svg/files/ai.svg') }}"
                                                        alt="icon" />
                                                </div>
                                                <!--end::Avatar-->
                                                <!--begin::Details-->
                                        ...
                                        <div class="d-flex flex-stack py-4">
                                            <div class="d-flex align-items-center">
                                                <!--begin::Avatar-->
                                                <div class="symbol symbol-35px">
                                                    <img src="{{ url('panel/assets/media/svg/files/doc.svg') }}"
                                                        alt="icon" />
                                                </div>
                                                <!--end::Avatar-->
                                                <!--begin::Details-->
                        ...
                        <div data-kt-stepper-element="content">
                            ...
                            <div class="w-100">
                                ...
                                <div class="text-center px-4">
                                    <img src="{{ url('panel/assets/media/illustrations/sketchy-1/9.png') }}" alt=""
                                    ...
                                    <div class="d-flex flex-column mb-7 fv-row">
                                        ...
                                        <div class="position-relative">
                                            ...
                                            <div class="position-absolute translate-middle-y top-50 end-0 me-5">
                                                <img src="{{ url('panel/assets/media/svg/card-logos/visa.svg') }}"
                                                    alt="" class="h-25px" />
                                                <img src="{{ url('panel/assets/media/svg/card-logos/mastercard.svg') }}"
                                                    alt="" class="h-25px" />
                                                <img src="{{ url('panel/assets/media/svg/card-logos/american-express.svg') }}"
                                                    alt="" class="h-25px" />
                                            </div>
                                            <!--end::Card logos-->
                                        </div>
                            ...
                            <div data-kt-stepper-element="content">
                                <div class="w-100 text-center">
                                    ...
                                    <div class="text-center px-4 py-15">
                                        <img src="{{ url('panel/assets/media/illustrations/sketchy-1/9.png') }}"
                    ...
                    <div class="py-5">
                            ...
                            <div class="mh-375px scroll-y me-n7 pe-7">
                                ...
                                <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="4">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="symbol symbol-35px symbol-circle">
                                            <img alt="Pic"
                                                src="{{ url('panel/assets/media/avatars/300-25.jpg') }}" />
                                        </div>
                                        <!--end::Avatar-->
                                        <!--begin::Details-->
                                        <div class="ms-5">
                                ...
                                <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="6">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <!--begin::Avatar-->
                                        <div class="symbol symbol-35px symbol-circle">
                                            <img alt="Pic" src="{{ url('panel/assets/media/avatars/300-9.jpg') }}" />
                                        </div>
                                        <!--end::Avatar-->
                                        <!--begin::Details-->
                                        <div class="ms-5">
                                ...
                                <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="9">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="symbol symbol-35px symbol-circle">
                                            <img alt="Pic"
                                                src="{{ url('panel/assets/media/avatars/300-23.jpg') }}" />
                                        </div>
                                        <!--end::Avatar-->
                                        <!--begin::Details-->
                                        <div class="ms-5">
                                ...
                                <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="11">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="symbol symbol-35px symbol-circle">
                                            <img alt="Pic"
                                                src="{{ url('panel/assets/media/avatars/300-12.jpg') }}" />
                                        </div>
                                        <!--end::Avatar-->
                                        <!--begin::Details-->
                                        <div class="ms-5">
                                ...
                                <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="13">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="symbol symbol-35px symbol-circle">
                                            <img alt="Pic"
                                                src="{{ url('panel/assets/media/avatars/300-13.jpg') }}" />
                                        </div>
                                        <!--end::Avatar-->
                                        <!--begin::Details-->
                                        <div class="ms-5">
                                ...
                                <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="15">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="symbol symbol-35px symbol-circle">
                                            <img alt="Pic"
                                                src="{{ url('panel/assets/media/avatars/300-21.jpg') }}" />
                                        </div>
                                        <!--end::Avatar-->
                                        <!--begin::Details-->
                                        <div class="ms-5">
                        ...
                        <div data-kt-search-element="empty" class="text-center d-none">
                            ...
                            <div class="text-center px-5">
                                <img src="{{ url('panel/assets/media/illustrations/sketchy-1/1.png') }}" alt=""
