...
@section('mainTitle', 'Sipariş Detayları')
@section('path1', 'Panel')
@section('footer_js')
        ...
        <div class="d-flex flex-column gap-7 gap-lg-10">
            <div class="d-flex flex-wrap flex-stack gap-5 gap-lg-10">
                ...
                <ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-bold mb-lg-n2 me-auto">
                    ...
                    <!--begin:::Tab item-->
                    <li class="nav-item">
                        <a class="nav-link text-active-primary pb-4" data-bs-toggle="tab" href="#kt_ecommerce_sales_order_history">İşlem Geçmişi</a>
                    </li>
                    <!--end:::Tab item-->
                </ul>
            </div>
                                ...
                                <tbody class="fw-bold text-gray-600">
                                    ...
                                    <tr>
                                        <td class="text-muted">
                                            ...
                                            <!--end::Svg Icon-->Sipariş Tarihi</div>
                                        </td>
                                        <td class="fw-bolder text-end">{{ date('d/m/Y H:i', strtotime($order->created_at)) }}</td>
                                    </tr>
                                    <!--end::Date-->
                                    ...
                                    <tr>
                                        ...
                                        <td class="fw-bolder text-end">{{$order->payment_name}}
                                        </td>
                                    </tr>
                                    <!--end::Payment method-->
                                    <!--begin::Date-->
                                    <tr>
                                        <td class="text-muted">
                                            ...
                                            <!--end::Svg Icon-->Kargo</div>
                                        </td>
                                        <td class="fw-bolder text-end">{{$order->payment_name}}</td>
                                    </tr>
                                    <!--end::Date-->
                                </tbody>
                                <!--end::Table body-->
                            ...
                            <table class="table align-middle table-row-bordered mb-0 fs-6 gy-5 min-w-300px">
                                ...
                                <tbody class="fw-bold text-gray-600">
                                                ...
                                                {{-- <div class="symbol symbol-circle symbol-25px overflow-hidden me-3">
                                                    <a href="#">
                                                        <div class="symbol-label">
                                                            <img src="{{ url('panel/assets/media/avatars/300-23.jpg' ) }}" alt="Dan Wilson" class="w-100" />
                                                        </div>
                                                    </a>
                                                </div> --}}
                                                <!--end::Avatar-->
                                                <!--begin::Name-->
                                                <a class="text-gray-600 text-hover-primary">{{$order->user_name}} {{$order->user_surname}}</a>
                                                <!--end::Name-->
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="fw-bolder text-end">
                                            <a class="text-gray-600 text-hover-primary">{{$order->user_mail}}</a>
                                        </td>
                                    </tr>
                                    <!--end::Payment method-->
                                    <!--begin::Date-->
                                    <tr>
                                        ...
                                        <td class="fw-bolder text-end">{{$order->address_tel}}</td>
                                    </tr>
                                    <!--end::Date-->
                                </tbody>
                                <!--end::Table body-->
                                ...
                                <tbody class="fw-bold text-gray-600">
                                    ...
                                    <tr>
                                        ...
                                        @if ($order->order_status == 'Bekleniyor')
                                            <td class="fw-bolder text-end">
                                                <div class="badge badge-light-warning">{{ $order->order_status }}</div>
                                            </td>
                                        @elseif($order->order_status == 'Hazırlanıyor')
                                            <td class="fw-bolder text-end ">
                                                <div class="badge badge-light-primary"> {{ $order->order_status }}</div>
                                            </td>
                                        @elseif($order->order_status == 'Kargoya Verildi')
                                            <td class="fw-bolder text-end ">
                                                <div class="badge badge-light-info">{{ $order->order_status }}</div>
                                            </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="fw-bolder text-end">
                                            <a  class="text-gray-600 text-hover-primary">{{$order->cargo_name}}</a>
                                        </td>
                                    </tr>
                                    <!--end::Shipping-->
                                    <!--begin::Rewards-->
                        ...
                        <div class="d-flex flex-column flex-xl-row gap-7 gap-lg-10">
                            ...
                            <div class="card card-flush py-4 flex-row-fluid overflow-hidden">
                                ...
                                <div class="position-absolute top-0 end-0 opacity-10 pe-none text-end">
                                    <img src="{{ url('panel/assets/media/icons/duotune/ecommerce/ecm001.svg' ) }}" class="w-175px" />
                                </div>
                                <!--end::Background-->
                                <!--begin::Card header-->
                                <div class="card-header">
                            ...
                            <div class="card card-flush py-4 flex-row-fluid overflow-hidden">
                                <!--begin::Background-->
                                <div class="position-absolute top-0 end-0 opacity-10 pe-none text-end">
                                    <img src="{{ url('panel/assets/media/icons/duotune/ecommerce/ecm006.svg' ) }}" class="w-175px" />
                                </div>
                                <!--end::Background-->
                                <!--begin::Card header-->
                                <div class="card-header">
                                    ...
                                    <table class="table align-middle table-row-dashed fs-6 gy-5 mb-0">
                                        ...
                                        <tbody class="fw-bold text-gray-600">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <a href="#" class="symbol symbol-50px">
                                                            <span class="symbol-label" style="background-image:blue;"></span>
                                                        </a>
                                                        <!--end::Thumbnail-->
                                                        <!--begin::Title-->
                                                        <div class="ms-5">
                                                            <a href="#" class="fw-bolder text-gray-600 text-hover-primary">{{$cart->product_name}}</a>
                                                            {{-- <div class="fs-7 text-muted">Delivery Date: 22/01/2022</div> --}}
                                                        </div>
                                                        <!--end::Title-->
                                                    </div>
                                                </td>
                                                <!--end::Product-->
                                                <!--begin::SKU-->
                                                <td class="text-end">{{$cart->product_code}}</td>
                                                <!--end::SKU-->
                                                <!--begin::Quantity-->
                                                <td class="text-end">{{$cart->cart_qty}}</td>
                                                <!--end::Quantity-->
                                                <!--begin::Price-->
                                                {{-- <td class="text-end">{{$cart->}}</td> --}}
                                                <!--end::Price-->
                                                <!--begin::Total-->
                                                <td class="text-end">{{$cart->cart_total}}</td>
                                                <!--end::Total-->
                                            </tr>
                                            @endforeach
                                            ...
                                            {{-- <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <!--begin::Title-->
                                                        <div class="ms-5">
                                                            <a href="#" class="fw-bolder text-gray-600 text-hover-primary">Footwear</a>
                                                            <div class="fs-7 text-muted">Delivery Date: 22/01/2022</div>
                                                        </div>
                                                        <!--end::Title-->
                                                    </div>
                                            ...
                                            <!--begin::VAT-->
                                            <tr>
                                                <td colspan="4" class="text-end">Vergi (%18)</td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-dark fs-3 fw-boldest text-end">{{cartTotal()}}</td>
                                            </tr>
                                            {{-- @endforeach --}}
                            ...
                            <div class="card-body pt-0">
                                <div class="table-responsive">
                                    ...
                                    <table class="table align-middle table-row-dashed fs-6 gy-5 mb-0">
                                        ...
                                        <thead>
                                            <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                                <th class="min-w-100px">GÜNCELLEME TARİHİ</th>
                                                <th class="min-w-70px">Durumu</th>
                                            </tr>
                                        </thead>
                                        <!--end::Table head-->
                                        <!--begin::Table body-->
                                        <tbody class="fw-bold text-gray-600">
                                            ...
                                            <tr>
                                                ...
                                                <!--begin::Status-->
                                                <td>
                                                    @if ($update->status == 'Bekleniyor')
                                                    <!--begin::Badges-->
                                                    <div class="badge badge-light-dark">{{ $update->status }}</div>
                                                    <!--end::Badges-->
                                                    @elseif($update->status == 'Hazırlanıyor')
                                                    <!--begin::Badges-->
                                                    <div class="badge badge-light-warning">{{ $update->status }}</div>
                                                    <!--end::Badges-->
                                                    @elseif($update->status == 'Kargoya Verildi')
                                                    <!--begin::Badges-->
                                                    <div class="badge badge-light-primary">{{ $update->status }}</div>
                                                    <!--end::Badges-->
                                                    @elseif($update->status == 'Tamamlandı')
                                                    <!--begin::Badges-->
                                                    <div class="badge badge-light-success">{{ $update->status }}</div>
                                                    <!--end::Badges-->
                                                    @else
                                                    @endif
